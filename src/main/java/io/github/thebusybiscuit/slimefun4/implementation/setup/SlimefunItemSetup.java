...
public final class SlimefunItemSetup {
    ...
    public static void setup(@Nonnull Slimefun plugin) {
        ...
        new UnplaceableBlock(itemGroups.technicalComponents, SlimefunItems.HARDENED_GLASS, RecipeType.ENHANCED_CRAFTING_TABLE,
        ...
        new ItemStack[] {null, new ItemStack(Material.WATER_BUCKET), null, SlimefunItems.ELECTRO_MAGNET, SlimefunItems.GOLD_PAN, SlimefunItems.ELECTRO_MAGNET, SlimefunItems.COPPER_INGOT, SlimefunItems.COPPER_INGOT, SlimefunItems.COPPER_INGOT})
        .setCapacity(128)
        .setEnergyConsumption(3)
        .setProcessingSpeed(1)
        .register(plugin);
        ...
        new ItemStack[] {new ItemStack(Material.REDSTONE), new ItemStack(Material.ANVIL), new ItemStack(Material.REDSTONE), SlimefunItems.CARBONADO, new ItemStack(Material.ENCHANTING_TABLE), SlimefunItems.CARBONADO, new ItemStack(Material.OBSIDIAN), new ItemStack(Material.OBSIDIAN), new ItemStack(Material.OBSIDIAN)})
        .setCapacity(128)
        .setEnergyConsumption(9)
        .setProcessingSpeed(1)
        .register(plugin);
        ...
        new ItemStack[] {SlimefunItems.REINFORCED_ALLOY_INGOT, SlimefunItems.BLISTERING_INGOT_3, SlimefunItems.REINFORCED_ALLOY_INGOT, new ItemStack(Material.ANVIL), SlimefunItems.AUTO_DISENCHANTER, new ItemStack(Material.ANVIL), new ItemStack(Material.OBSIDIAN), SlimefunItems.BIG_CAPACITOR, new ItemStack(Material.OBSIDIAN)})
        .setCapacity(1024)
        .setEnergyConsumption(24)
        .setProcessingSpeed(3)
        .register(plugin);

        new AutoAnvil(itemGroups.electricity, 40, SlimefunItems.AUTO_ANVIL, RecipeType.ENHANCED_CRAFTING_TABLE,
        ...
        new AutoAnvil(itemGroups.electricity, 100, SlimefunItems.AUTO_ANVIL_2, RecipeType.ENHANCED_CRAFTING_TABLE,
